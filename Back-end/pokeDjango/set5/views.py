...
from .models import PokemonSet5
from api.serializers import PokemonSet5Serializer

# Create your views here.
class PokemonSet5View(APIView):
    def get(self, request):
        url = "https://api.pokemontcg.io/v2/cards?q=set.id:sv8pt5&select=id,name,supertype,number,rarity,images&orderBy=number&18aca43d-42e6-4870-8dd9-0e15e6a6fd1b"
        page = 1
        page_size = 250
        ...
        if response.status_code == 200:
            ...
            for set_data in data:
                ...
                if not PokemonSet5.objects.filter(id=id_set).exists():
                    nuevo_set = PokemonSet5.objects.create(
                        id=id_set,
                        name=name,
                        supertype=supertype,
                        number=number,
            ...
            sets = PokemonSet5.objects.all()
            serializer = PokemonSet5Serializer(sets, many=True)
